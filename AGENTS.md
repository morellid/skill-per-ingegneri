...
- `skills/cer-cacer-configurazione-gse/` - configurazione di CER (Comunita' di Energia Rinnovabile), GAC (Gruppo di Autoconsumatori) o AID (Autoconsumatore Individuale a Distanza) e qualifica al servizio CACER del GSE: verifica perimetro cabina primaria, scelta forma, redazione guidata dello statuto, simulazione semplificata di energia condivisa, TIP, tariffa di restituzione (TR) e contributo PNRR per Comuni < 5.000 ab., checklist documentale per la qualifica al portale GSE, ai sensi del D.Lgs. 199/2021 art. 30-32 + DM MASE 7/12/2023 n. 414 + Delibera ARERA 727/2022/R/eel (TIAD) + Regole Operative CACER del GSE
