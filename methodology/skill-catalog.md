...
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------- | ----------- | ------------------------------------------------ |
| SC.1  | **Spettro di risposta NTC §3.2** (gia' skill in repo: [`spettro-risposta-ntc`](../skills/spettro-risposta-ntc/)) - input: coordinate sito + vita nominale + classe uso + cat. sottosuolo. Output: ag, F0, T*c per SLO/SLD/SLV/SLC + Se(T)   | [NTC 2018 §3.2 + Allegato A](https://www.gazzettaufficiale.it/eli/id/2018/2/20/18A00716/sg) + [reticolo INGV](http://zonesismiche.mi.ingv.it/)         | Altissimo (ogni progetto sismico) | Medio       | Basso (deterministico, verificabile vs Excel CSLP) |
...
9. **Spettro di risposta NTC §3.2 code-driven** (SC.1) - prerequisito ogni progetto sismico, output verificabile vs Excel CSLP - **gia' in repo come [`spettro-risposta-ntc`](../skills/spettro-risposta-ntc/) v0.1.0-alpha**
