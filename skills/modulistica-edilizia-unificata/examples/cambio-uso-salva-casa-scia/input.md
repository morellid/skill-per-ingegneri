# Input - cambio destinazione d'uso da residenziale a turistico-ricettivo (Salva Casa)
...
| Frazionamento UI | NO |
| Modifica volumetria | NO |
| Modifica sagoma / prospetti | NO |
| Vincolo paesaggistico | NO |
| Vincolo culturale | NO |
| Vincolo idrogeologico | NO |
| Zona urbanistica | B (consolidato), fuori centro storico |
| Sismica | Zona 3 (Milano) - opere non strutturali |
| Cantiere | Mono-impresa per aggiunta bagno (durata < 30 gg, 2 lavoratori) |
| Attivita' antincendio | DA-VERIFICARE: foresteria con 5 camere e' attivita' DPR 151/2011 punto 66 (strutture turistico-alberghiere) **solo sopra 25 posti letto**; 5 camere x 2 = 10 posti letto, sotto soglia. **Verifica con VVF**, anche per categorie escluse (es. prevenzione incendi a richiesta) |
| Intervento energetico | NO |
| Modalita' di affidamento | Privato |

## Domande dell'utente

1. Il Salva Casa si applica al cambio destinazione d'uso senza opere?
2. Quale modulo edilizio (CILA / SCIA / PdC)?
3. Sono dovuti standard urbanistici e parcheggi pertinenziali per la nuova destinazione?
4. Quali allegati specifici per il cambio uso?
5. Gli adempimenti SUAP turismo (CIN, classificazione strutture extra-alberghiere) sono separati dal modulo edilizio?
