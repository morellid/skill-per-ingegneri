...
2. **Grande impresa** tra i partecipanti -> incompatibile con la qualita' di **socio CER** (art. 31 D.Lgs. 199/2021). Nel GAC ex art. 30 c. 2 il partecipante e' un autoconsumatore, non socio di un ente CER, quindi **il vincolo "no grandi imprese" della CER non si applica al GAC**. La verifica residua e' solo documentale, sui requisiti soggettivi GAC delle Regole Operative GSE vigenti.
