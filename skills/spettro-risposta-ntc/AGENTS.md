...
- Validazione: Livello 1 self-check OK (`./scripts/validate.sh spettro-risposta-ntc`); test suite Python: 23/23 pass; Livello 2 da completare prima del release stabile.
- Task files:
