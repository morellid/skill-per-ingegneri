...
Self-assessment di conformita' al **D.Lgs. 4 settembre 2024, n. 138** (recepimento italiano della Direttiva (UE) 2022/2555 - NIS 2) per organizzazioni italiane private e pubbliche. La skill copre sei angoli: perimetro (essenziale/importante/fuori), gap analysis sulle misure di base ACN (Determinazione 379907/2025 vigente dal 15/01/2026), **elenco fornitori rilevanti NIS** ex art. 18 Determinazione ACN 127437/2026 (finestra annuale 15 aprile - 31 maggio), **categorizzazione delle attivita' e dei servizi** ex art. 30 D.Lgs. 138/2024 secondo il modello della Determinazione ACN 155238/2026 (finestra annuale 1 maggio - 30 giugno, Capo V Det. 127437/2026), verifica di significativita' di un incidente (codici IS-1..4 + soglie telco art. 6 co. 2), obblighi di governance dell'organo di amministrazione.
...
- **Determinazione ACN n. 127437 del 13/04/2026** (id `acn-det-127437-2026`, vigente dal 15/04/2026; Capo V dal 01/05/2026) - termini, modalita' e procedimenti di utilizzo della piattaforma digitale ACN; aggiorna e sostituisce la Det. 379887/2025. Articoli chiave: art. 1 lett. ll) definizione "fornitori rilevanti NIS" (2 criteri alternativi); art. 16 finestra aggiornamento annuale 15 aprile - 31 maggio; art. 18 elenco dei fornitori rilevanti NIS con 5 informazioni richieste (denominazione, CF, Paese, codici CPV Reg. CE 2195/2002, criterio di rilevanza); Capo V (artt. 20-21) trasmissione dell'elenco categorizzato delle attivita' e dei servizi ("Servizio NIS/Categorizzazione", finestra 1 maggio - 30 giugno) e verifiche di conformita' a campione.
- **Determinazione ACN n. 155238 del 20/04/2026** (id `acn-det-155238-2026`, con allegati `acn-det-155238-2026-allegato-1` e `acn-det-155238-2026-allegato-2`; si applica dal 01/05/2026, art. 8 co. 2) - modello di categorizzazione delle attivita' e dei servizi ex art. 30 co. 2 e art. 40 co. 5 lett. i) D.Lgs. 138/2024: 10 macro-aree con categoria di rilevanza pre-assegnata, 4 categorie (impatto alto/medio/basso/minimo); allegato 1 per le tipologie nn. 1, 2, 5, 6, 7, 10 all. I + nn. 1-5 all. II + n. 1 all. IV, allegato 2 per gli altri (unica differenza: Logistica, basso vs minimo); deroga alla pre-assegnata con valutazione documentata (art. 3 co. 3); coordinamento Regolamento Cloud PA (art. 4) e PSNC = impatto alto fuori modello (art. 5).
- **Guida alla lettura del modello di categorizzazione ACN v1.0, aprile 2026** (id `acn-modello-categorizzazione-guida`) - documento di supporto (processo facoltativo in 3 fasi, criteri Appendice B): utile per il metodo, non fonte di obblighi.
...
- `acn-det-155238-2026-categorizzazione.md` - modello di categorizzazione (macro-aree, categorie, deroga, coordinamenti) + processo della Guida + Capo V Det. 127437/2026 (trasmissione e verifiche)
...
- **Art. 30 D.Lgs. 138/2024 + Det. ACN 155238/2026 - Elenco categorizzato attivita' e servizi**: dal **1 maggio al 30 giugno** di ogni anno (prima applicazione: 2026, art. 42 co. 2 decreto NIS) i soggetti NIS comunicano tramite il "Servizio NIS/Categorizzazione" l'elenco di **tutte** le attivita' svolte e i servizi erogati, internamente ed esternamente (art. 3 co. 1 Det. 155238/2026), con macro-area, denominazione, descrizione e categoria di rilevanza (art. 3 co. 2). Default = categoria pre-assegnata della macro-area; deroga con valutazione d'impatto documentata e conservata (art. 3 co. 3); macro-aree vuote non richieste (art. 3 co. 4). Casi speciali: classificazione Regolamento Cloud PA in luogo del modello (art. 4); attivita'/servizi PSNC = impatto alto, fuori dall'art. 3 (art. 5).
- **Capo V Det. ACN 127437/2026 (artt. 20-21) - Trasmissione e verifiche dell'elenco categorizzato**: conferma del punto di contatto ex DPR 445/2000 (art. 20 co. 3); decorso il 30 giugno l'elenco e' definitivamente acquisito (co. 4); sottomissioni tardive precluse salvo documentate criticita' tecnico-operative non imputabili (co. 5); **esenzione DORA** salva adesione volontaria (co. 6) - al contrario dell'elenco fornitori rilevanti, dove l'esenzione non opera. Verifiche ACN a campione (art. 21): riscontro entro 90 giorni prorogabile +60, integrazioni sospendono i termini e vanno riscontrate entro 30 giorni pena rigetto, silenzio = convalida, esito negativo non solleva dall'obbligo ex art. 30 co. 1.
...
- Versione: vedi `CHANGELOG.md` (v0.3.0-alpha)
- Validazione: Livello 1 (auto-validazione autore) - Livello 2 da pianificare
- Task files: 6 (`valuta-perimetro`, `gap-analysis-misure`, `elenco-fornitori-rilevanti`, `categorizza-attivita-servizi`, `verifica-incidente-significativo`, `check-obblighi-governance`)
- Estratti normativi: 13 estratti preparati
