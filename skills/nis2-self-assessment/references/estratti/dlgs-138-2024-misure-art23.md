# D.Lgs. 138/2024 - Governance e misure (artt. 23, 24)
...
> Estratto verbatim degli articoli rilevanti per gli obblighi sostanziali e di governance.
...
- **Approvazione**: l'organo di amministrazione (CdA) **approva** il piano di implementazione delle misure ex art. 24. Non basta che le misure siano adottate dal management tecnico: serve un atto formale del CdA.
- **Sovrintendenza**: l'organo vigila sull'implementazione di tutti gli obblighi del Capo IV (artt. 23-29) e dell'art. 7 (registrazione/aggiornamento sulla piattaforma ACN).
- **Responsabilita'**: i membri dell'organo sono **responsabili delle violazioni** del decreto. L'art. 38 co. 5 e 6 specifica che le persone fisiche con poteri di rappresentanza/decisione/controllo possono essere sanzionate con la misura accessoria di **incapacita' a svolgere funzioni dirigenziali** se il soggetto non ottempera alla diffida.
- **Formazione obbligatoria**: l'organo deve seguire formazione cyber. Deve **promuovere** la formazione anche per i dipendenti (offerta periodica).
- **Informazione**: l'organo deve essere informato periodicamente o tempestivamente sugli incidenti e sulle relative notifiche (artt. 25-26).
...
I 10 elementi minimi (art. 24 co. 2 lett. a-l) costituiscono la **tassonomia ufficiale** delle misure NIS2:

| Lett. | Ambito | Riferimento Framework Naz. Cybersecurity (ed. 2025) |
|-------|--------|------------------------------------------------------|
| a | Politiche analisi rischi e sicurezza ICT | ID.RA / ID.GV |
| b | Gestione incidenti + procedure di notifica | DE.AE / RS.RP / RS.CO |
| c | Continuita' operativa, backup, DR, gestione crisi | RC.RP / PR.IP-9, PR.IP-10 |
| d | Sicurezza catena di approvvigionamento | ID.SC |
| e | Sicurezza SDLC + vulnerability disclosure | PR.IP-2 / RS.AN-5 |
| f | Valutazione efficacia delle misure | ID.RA-3 / ID.GV-4 |
| g | Igiene cyber e formazione | PR.AT |
| h | Crittografia / cifratura | PR.DS-1, PR.DS-2 |
