# D.Lgs. 138/2024 - Perimetro NIS (artt. 3, 6, 7)
...
> Estratto verbatim degli articoli rilevanti per la valutazione di perimetro.
...
> 1. Dal 1 gennaio al 28 febbraio di ogni anno successivo alla data di entrata in vigore del presente decreto, i soggetti di cui all'articolo 3, si registrano o aggiornano la propria registrazione sulla piattaforma digitale resa disponibile dall'Autorita' nazionale competente NIS [...]. A tal fine, tali soggetti forniscono o aggiornano almeno le informazioni seguenti:
>    a) la ragione sociale;
>    b) l'indirizzo e i recapiti aggiornati [...];
>    c) la designazione di un punto di contatto, indicando il ruolo presso il soggetto e i recapiti aggiornati [...];
>    d) ove applicabile, i pertinenti settori, sottosettori e tipologie di soggetto di cui agli allegati I, II, III e IV;
>
> 2. Entro il 31 marzo di ogni anno successivo alla data di entrata in vigore del presente decreto, l'Autorita' nazionale competente NIS [...] redige [...] l'elenco dei soggetti essenziali e dei soggetti importanti, sulla base delle registrazioni di cui al comma 1 [...].
>
...
>    c) i responsabili di cui all'articolo 38, comma 5, indicando il ruolo presso il soggetto e i loro recapiti aggiornati [...];
>    d) un sostituto del punto di contatto di cui al comma 1, lettera c) [...].
>
...
- Finestra annuale di registrazione/aggiornamento: 1 gen - 28 feb.
- Comunicazione dell'inserimento: entro 31 mar.
- Finestra di integrazione (IP, domini, responsabili): 15 apr - 31 mag.
- Notifica modifiche: entro **14 giorni**.
- Per il primo anno (2025) le scadenze sono state modulate dall'Autorita' (cfr. comunicazioni ACN sul portale `acn.gov.it/portale/en/nis/la-normativa`).
