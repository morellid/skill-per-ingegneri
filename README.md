...
| [`predimensionamento-flessione-ca-ntc`](skills/predimensionamento-flessione-ca-ntc/) | Calcolo code-driven del momento resistente M_Rd di sezione rettangolare in c.a. singolarmente armata in flessione semplice SLU (NTC par. 4.1.2.1 e 4.1.2.3.4.2): dato b/h/d/As/fck/fyk restituisce f_cd, f_yd, x, x/d, eps_s, z, M_Rd in kNm con verifica duttilita' (snervamento + raccomandazione x/d <= 0.45). Solo Classe 1 (fck <= 50 MPa), solo singolarmente armata, solo flessione semplice SLU | NTC 2018 par. 4.1.2 + Circ. 7/2019 par. C4.1.2 |
...
│   ├── predimensionamento-flessione-ca-ntc/
