...
| [`cer-cacer-configurazione-gse`](skills/cer-cacer-configurazione-gse/) | Configurazione di CER, GAC o AID con verifica perimetro cabina primaria, redazione guidata dello statuto, simulazione semplificata di energia condivisa, TIP, tariffa di restituzione e contributo PNRR per Comuni < 5.000 ab., e checklist documentale per la qualifica al portale GSE | D.Lgs. 199/2021 art. 30-32 + DM MASE 7/12/2023 n. 414 + Delibera ARERA 727/2022/R/eel (TIAD) + Regole Operative CACER del GSE |
